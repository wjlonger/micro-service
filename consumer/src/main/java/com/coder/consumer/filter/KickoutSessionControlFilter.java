package com.coder.consumer.filter;

import com.alibaba.fastjson.JSON;
import com.coder.base.model.SysUser;
import com.coder.util.CloseUtils;
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if (session.getAttribute(KICKOUT) != null  && (boolean)session.getAttribute(KICKOUT)) {
            ...
            if (XMLHTTPREQUEST.equalsIgnoreCase(((HttpServletRequest) request).getHeader(X_REQUESTED_WITH))) {
                resultMap.put("code", String.valueOf(com.coder.consumer.enumeration.User.ISLOGIN.getCode()));
                resultMap.put("msg", com.coder.consumer.enumeration.User.ISLOGIN.getMsg());
                //输出json串
